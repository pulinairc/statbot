 ...
 * contents of Gumbo.xs. Do not edit this file, edit Gumbo.xs instead.
 *
 *	ANY CHANGES MADE HERE WILL BE LOST! 
 *
 */

#line 1 "lib/HTML/Gumbo.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
#line 539 "lib/HTML/Gumbo.c"

XS(XS_HTML__Gumbo_parse_to_string); /* prototype to pass -Wmissing-prototypes */
XS(XS_HTML__Gumbo_parse_to_string)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_HTML__Gumbo_parse_to_tree); /* prototype to pass -Wmissing-prototypes */
XS(XS_HTML__Gumbo_parse_to_tree)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_HTML__Gumbo__parse_to_callback); /* prototype to pass -Wmissing-prototypes */
XS(XS_HTML__Gumbo__parse_to_callback)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 3)
       croak_xs_usage(cv,  "self, buffer, cb, ...");
    {
	SV *	self = ST(0);
	SV *	buffer = ST(1);
	SV *	cb = ST(2);
#line 524 "lib/HTML/Gumbo.xs"
        const char* str = prepare_buffer(aTHX_ buffer);
...
extern "C"
#endif
XS(boot_HTML__Gumbo); /* prototype to pass -Wmissing-prototypes */
XS(boot_HTML__Gumbo)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("HTML::Gumbo::parse_to_string", XS_HTML__Gumbo_parse_to_string, file);
        newXS("HTML::Gumbo::parse_to_tree", XS_HTML__Gumbo_parse_to_tree, file);
        newXS("HTML::Gumbo::_parse_to_callback", XS_HTML__Gumbo__parse_to_callback, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
