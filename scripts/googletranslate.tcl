...
set trans(cmd) "!googletranslate"; #public command trigger
set trans(dcccmd) "googletranslate"; #public command trigger
set trans(usage) "Käyttö: $trans(cmd) <lause>";
set trans(prefix) ""; #output prefix
set trans(url) "http://translate.google.com/translate_a/t"; #url
set trans(lang) "fi"; #default language
...
proc pub:trans { nick uhost handle channel arg } {
	...
	putserv "PRIVMSG $channel : Käännetty: $result";
}
...
putlog "Script loaded: \002trans.tcl $trans(ver)\002";
